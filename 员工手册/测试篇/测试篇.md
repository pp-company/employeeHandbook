...
15. TDD 先写测试，如果由于某些原因先写了实现，你不能看，如果看了要假装没看见
16. 如果有发现test没覆盖的bug，这个bug本来应该被上一层的test抓住的，结果没抓住，流到下一层了。那应该回到上一层补充test.
    例:你喝水中毒了，然后你去水厂debug，结果发现是旁边的化工厂泄露了，化工厂的test没发现泄露，那你应该给化工厂补test而不是给水厂补test
17. 测试总流程:
    1. 注入被你测试的东西(不要自己造)
